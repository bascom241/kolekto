...
const CreateCollectionForm: React.FC = () => {
  ...
  const [isMaxParticipantsEnabled, setIsMaxParticipantsEnabled] =
    useState(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const maxParticipantsValue = isMaxParticipantsEnabled
    ...
    console.log(participant, "participant etai");
    ...
    const payload = {
      ...
      participantInformation: Object.values(participant),
      generateUniqueCodes,
      ...
      <div className="space-y-4">
            ...
            <CardContent className="pt-4">
              <div className="space-y-4">
                ...
                <RadioGroup
                  value={feeBearer}
                  onValueChange={(value) =>
                    setFeeBearer(value as "organizer" | "contributor")
                  }
                  className="space-y-3"
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="organizer">
                      Organizer pays charges (deducted from collection)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="contributor" id="contributor" />
                    <Label htmlFor="contributor">
                      Contributor pays charges (added to payment amount)
                    </Label>
                  </div>
                </RadioGroup>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm border-t border-gray-200 pt-3">
                  ...
                  <div className="text-right">
                    ₦
                    {kolektoFee.toLocaleString(undefined, {
                  ...
                  <div className="text-right">
                    ₦
                    {paymentGatewayFee.toLocaleString(undefined, {
                      maximumFractionDigits: 2,
                    })}
                  </div>

                  <div className="border-t border-gray-200 pt-1 font-medium">
                    Total Fees:
                  </div>
                  <div className="border-t border-gray-200 pt-1 text-right font-medium">
                    ₦
                  ...
                  {feeBearer === "contributor" && (
                    <>
                      ...
                      <div className="pt-3 text-right font-bold">
                        ₦
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 sm:space-x-4">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="maxParticipantsToggle">
          ...
          {generateUniqueCodes && (
            <div className="mt-4 space-y-2">
              ...
              <p className="text-sm text-gray-500">
                Unique codes will be generated for each person who pays. If
                someone pays for multiple people, each person will get their own
                code.
              </p>
            </div>
          )}
